        ...
        <div className="absolute inset-0 pointer-events-none text-slate-800 font-sans">
            ...
            <div className="absolute top-6 right-6 flex flex-col items-end gap-4 pointer-events-auto">
                ...
                >
                    {[0, 1, 2, 5, 20].map((s) => (
                        <button 
                            ...
                            className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ${
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg font-bold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ${
                        isPanMode 
